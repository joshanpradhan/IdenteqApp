...
const styles = StyleSheet.create({
  ...
  small:{   fontFamily:"roboto",  fontSize: theme.sizes.small, color: theme.colors.black,textTransform:"capitalize"},
  bold: { fontFamily: "robotoBold" },
  light: { fontFamily: "robotoSemibold" },
  medium: { fontFamily: "robotoMedium" },
